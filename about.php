  ...
  <div>
    ...
    <div class="container-fluid degrade">
      <div class="container py-5">
        <div class="row g-5 align-items-center">
          <div class="col-lg-7">
            <h1 class="h1-welcome">Sobre mim</h1>
            <p class="p-welcome">
              Sou Adriana Pinheiro, Psicóloga Clínica, Especialista em Terapia Cognitiva Comportamental (tema do meu Trabalho de Conclusão de Curso) e, 
              atualmente estou realizando Pós-Graduação em Sexologia. Fundadora do projeto social Ser Mulher, onde há espaço para encontros inspiradores 
              e troca de vivências entre diferentes histórias. Sou líder de mulheres em uma trajetória que possui mais de 15 anos e tenho muito 
              orgulho em TRANSBORDAR na vida das minhas Amadinhas. 
            </p>
            <a class="a-btn" target="_blank" href="https://wa.me/5511956378692">
              <button type="button" class="button-contact-two btn-primary">
                <img src="img/whats.png" alt="logo" width="40" height="40">
              </button>
            </a>
            <a class="a-btn" target="_blank" href="https://www.instagram.com/psiadrianapinheiro/">
              <button type="button" class="button-contact-two btn-primary">
                <img src="img/instagram.png" alt="logo" width="40" height="40">
              </button>
            </a>
          </div>
          <div class="col-lg-5 animated fadeIn justify-content-md-center">  
            <img class="img-fluid p-3 polaroid" src="img/psi.png" alt="" width="400px" height="107px">
          </div>
        </div>
      </div>
    </div>
    <div class="container-fluid back">                  
      <div class="container py-3">
        <div class="row g-5 align-items-center">
          <div class="col-lg-4">
            <img class="img-fluid p-3 polaroid" src="img/about.png" alt="" width="300px">
          </div>
          <div class="col-lg-8 animated fadeIn justify-content-md-center">  
            <img class="img-fluid p-3 polaroid" src="img/aboutTwo.png" alt="" width="1900px">    
          </div>
        </div>
      </div>    
    </div> 
